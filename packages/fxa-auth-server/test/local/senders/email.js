...
const TESTS = new Map([
  ...
  ['subscriptionSubsequentInvoiceEmail', new Map([
    ['subject', { test: 'equal', expected: `${MESSAGE.planName} payment received` }],
    ['headers', new Map([
    ...
    ['html', [
      ...
      { test: 'include', expected: `latest payment for ${MESSAGE.planName}.` },
      { test: 'include', expected: `Invoice Number: <b>${MESSAGE.invoiceNumber}</b>` },
    ...
    ['text', [
      { test: 'include', expected: `${MESSAGE.planName} payment received` },
      { test: 'include', expected: `latest payment for ${MESSAGE.planName}.` },
      { test: 'include', expected: `Invoice Number: ${MESSAGE.invoiceNumber}` },
      { test: 'include', expected: `Plan change: $${MESSAGE.proratedAmount}` },
      { test: 'include', expected: `MasterCard card ending in 5309` },
  ...
  ['subscriptionCancellationEmail', new Map([
    ['subject', { test: 'equal', expected: `Your ${MESSAGE.planName} subscription has been cancelled` }],
    ['headers', new Map([
    ...
    ['html', [
      ...
      { test: 'include', expected: `cancelled your ${MESSAGE.planName} subscription` },
    ...
    ['text', [
      { test: 'include', expected: `Your ${MESSAGE.planName} subscription has been cancelled` },
      { test: 'include', expected: `cancelled your ${MESSAGE.planName} subscription` },
      { test: 'include', expected: `final payment of $${MESSAGE.invoiceTotal} was paid on 03/20/2020.` },
      { test: 'include', expected: `billing period, which is 04/19/2020.` },
      { test: 'notInclude', expected: 'utm_source=email' },
